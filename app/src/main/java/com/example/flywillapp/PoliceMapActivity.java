...
public class PoliceMapActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLogout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(PoliceMapActivity.this, MainActivity.class);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        DatabaseReference reference=FirebaseDatabase.getInstance().getReference().child("requests to police");
            ...
            public void onDataChange(@NonNull final DataSnapshot dataSnapshot) {
                for(final DataSnapshot snapshot:dataSnapshot.getChildren())
                {
                    ...
                    if(snapshot.child("status").getValue().toString().equals("0")) {
                        ...
                        Toast.makeText(PoliceMapActivity.this, snapshot.child("msg").getValue().toString(), Toast.LENGTH_SHORT).show();
                        feedback.setVisibility(View.VISIBLE);
                        feedback.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {

                                Intent i=new Intent(PoliceMapActivity.this,FeedBackPoliceActivity.class);
